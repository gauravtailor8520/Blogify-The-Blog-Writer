...
st.title("Welecome to Blogify...📑💭")
st.header("Create High-Quality Blog Content Without Breaking the Bank", divider="rainbow")



st.subheader(':grey[Title Generation]', divider='red') # Display a subheader for the title generation section
...
st.subheader(':grey[Blog Generation]', divider='red') # Display a subheader for the blog generation section
